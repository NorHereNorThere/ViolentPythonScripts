...
# By default, the result of packing a given C struct includes pad bytes in order to maintain proper alignment 
# for the C types involved; similarly, alignment is taken into account when unpacking. 
...
target = '192.168.0.110' #sys.argv[1]
command = 'PWND' #sys.argv[2]
